...
# financial_news_analysis documentation build
...
from financial_news_analysis import __version__ as release

# -- Project information -----------------------------------------------------

project = "financial_news_analysis"
author = "Kedro"
...
htmlhelp_basename = "financial_news_analysisdoc"
...
latex_documents = [
    (
        master_doc,
        "financial_news_analysis.tex",
        "financial_news_analysis Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "financial_news_analysis",
        "Project financial_news_analysis codebase.",
        "Data-Science",
    )
]
